...
public class AIMLFileReader implements AIMLProvider
{
    ...
    private AIMLFileReader(AIMLFileReader aimlFileReader)
    {
    ...
    private Collection<AIML> loadFromFile() throws ParserConfigurationException, SAXException, IOException
    {
        doc = XMLUtils.parseFileToXMLDocument(this.file);
        readingLine = 1;
